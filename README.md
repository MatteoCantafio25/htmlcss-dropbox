...
:point_right: font-family: 'Open Sans', sans-serif;
Info consegna:
...
In questa occasione avrete anche la possibilità di dare voi un feedback a noi su come vi state trovando :slightly_smiling_face:
Consigli:
